		...
		class Tweet < ActiveRecord::Base
			...
			def self.import
				if Social::Engine.config.twitter_enabled
					client = Social::Engine.config.twitter_consumer_key ? Twitter::Client.new consumer_key: Social::Engine.config.twitter_consumer_key, consumer_secret: Social::Engine.config.twitter_consumer_secret : Twitter
